...
void fw64_mesh_instance_update(fw64MeshInstance* mesh_instance) {
    ...
    guMtxF2L((float (*)[4])mesh_instance->base.node->transform.world_matrix, &mesh_instance->n64_matrix);
#endif
}

void fw64_mesh_instance_init(fw64MeshInstance* mesh_instance, fw64Node* node, fw64Mesh* mesh) {
    mesh_instance->base.type_id = FW64_COMPONENT_TYPE_MESH_INSTANCE;
    mesh_instance->base.node = node;
