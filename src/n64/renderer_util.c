...
static Gfx fullscreen_overlay_dl[] = {
    ...
    //gsSPMatrix(OS_K0_TO_PHYSICAL(&(overlay_matrix)), G_MTX_PROJECTION|G_MTX_LOAD|G_MTX_NOPUSH),
    //gsSPMatrix(OS_K0_TO_PHYSICAL(&(overlay_matrix)), G_MTX_MODELVIEW|G_MTX_LOAD|G_MTX_NOPUSH),
