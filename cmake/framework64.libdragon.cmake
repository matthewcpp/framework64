...
function (configure_core_library)
    ...
    target_compile_options(framework64 PUBLIC -march=vr4300 -mtune=vr4300 -falign-functions=32 -ffunction-sections -fdata-sections)

    # Configure debug / optimization settings based on build type
    string(TOUPPER "${CMAKE_BUILD_TYPE}" build_type)
    if(build_type STREQUAL "DEBUG")
        target_compile_options(framework64 PUBLIC -g)
    elseif(build_type STREQUAL "RELEASE")
        target_compile_options(framework64 PUBLIC -O3)
    endif()
...
function(create_game)
    set(options ALL_WARNINGS_AS_ERRORS WAIT_FOR_START)
    ...
    set(fw64_wait_for_start "0")
    if (${N64_ROM_WAIT_FOR_START})
        set(fw64_wait_for_start "1")
    endif()
    ...
    configure_file(${fw64_libdragon_src_dir}/libdragon_main.c ${game_binary_dir}/libdragon_main_${target_name}.c)
