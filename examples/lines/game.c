...
void game_init(Game* game, fw64Engine* engine) {
    ...
    entity_init(&game->solid_cube, fw64_mesh_load(engine->assets, FW64_ASSET_mesh_blue_cube));
    entity_init(&game->wire_cube, fw64_mesh_load(engine->assets, FW64_ASSET_mesh_blue_cube_wire));
