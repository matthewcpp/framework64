...
void game_init(Game* game, System* system) {
    ...
    n64_logo_sprite_init(&game->n64logo, assets_get_image(game->system->assets, ASSET_sprite_n64_logo));
    game->n64logo.position.x = 10;
    game->n64logo.position.y = 10;

    ken_sprite_init(&game->ken_sprite, assets_get_image(game->system->assets, ASSET_sprite_ken));
