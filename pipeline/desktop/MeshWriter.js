...
async function _writeMeshToFile(environment, mesh, materialBundle, file) {
    ...
    _writeMeshDataImpl(environment, mesh, materialBundle, writer, file);
}

/** The order that data is written in this function needs to match up with MeshInfo in desktop/mesh.cpp */
function _writeMeshInfo(mesh, writer, file) {
...
function _writeMeshDataImpl(environment, mesh, materialBundle, writer, file) {
