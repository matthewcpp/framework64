...
async function processWeb(manifestFile, assetDirectory, outputDirectory, plugins) {
    Desktop.runPipelineProcessor(manifestFile, assetDirectory, outputDirectory, plugins, "web", Environment.Architecture.Arch32);
}
